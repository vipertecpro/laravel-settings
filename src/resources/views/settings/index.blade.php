            ...
            <div class="text-right">
                <div class="btn-group">
                    <a href="#" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                        <i class="fa fa-plus-square-o" aria-hidden="true"></i> Add New Setting <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu">
                        @foreach($types as $key => $type)
                            <li><a href="{{ url(config('settings.route_prefix').'/create/'.$key) }}">{{ $type }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
                ...
                <tr class="">
                    <form method="get">
                        ...
                        <th>
                            ...
                            <a href="{{ url(config('settings.route_prefix')) }}"
